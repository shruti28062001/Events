            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-default">
                        <form method="POST" action="{{ url('admin/add-ratings') }}" enctype="multipart/form-data" id="addRatings">@csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="radio" name="stars" class="form-control" placeholder="Ratings" required>
                                    </div> 
                                </div>
                            </div>
